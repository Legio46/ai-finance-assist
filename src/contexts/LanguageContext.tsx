...
const translations: Record<string, Record<string, string>> = {
  en: {
    ...
    ourStory: 'Our Story',
    storyPara1: "Legio Financial was born from a simple observation: financial management shouldn't be complicated, expensive, or limited by geography. Whether you're a freelancer, startup, or an established business anywhere in the world, you deserve access to the same level of financial intelligence.",
    ...
    storyPara3: 'Today, Legio serves users across the globe, helping them save time, reduce costs, and make better financial decisions through the power of intelligent automation and expert insights.',
    globalReach: 'Global Reach',
    globalReachDesc: 'Legio Finance serves users worldwide. Our platform is designed to work seamlessly across borders, supporting multiple currencies and languages to help you manage your finances wherever you are.',
    comingSoon: 'Coming Soon',
    taxOptimization: 'Tax Optimization',
    taxOptimizationDesc: "We're working on advanced tax optimization features to help you minimize your tax burden legally and efficiently. Stay tuned for smart tax strategies tailored to your situation.",
  ...
  sk: {
    ...
    ourStory: 'Náš príbeh',
    storyPara1: "Legio Financial sa zrodilo z jednoduchého pozorovania: finančné riadenie by nemalo byť komplikované, drahé alebo obmedzené geografiou. Či už ste freelancer, startup alebo zavedený podnik kdekoľvek na svete, zaslúžite si prístup k rovnakej úrovni finančnej inteligencie.",
    ...
    storyPara3: 'Dnes Legio slúži používateľom po celom svete, pomáha im šetriť čas, znižovať náklady a robiť lepšie finančné rozhodnutia pomocou inteligentnej automatizácie a odborných poznatkov.',
    globalReach: 'Globálny dosah',
    globalReachDesc: 'Legio Finance slúži používateľom po celom svete. Naša platforma je navrhnutá tak, aby fungovala bez problémov cez hranice, podporujúc viacero mien a jazykov.',
    comingSoon: 'Už čoskoro',
    taxOptimization: 'Daňová optimalizácia',
    taxOptimizationDesc: 'Pracujeme na pokročilých funkciách daňovej optimalizácie, ktoré vám pomôžu legálne a efektívne minimalizovať vaše daňové zaťaženie. Sledujte nás pre inteligentné daňové stratégie.',
  ...
  de: {
    ...
    storyPara1: 'Legio Financial entstand aus einer einfachen Beobachtung: Finanzmanagement sollte nicht kompliziert, teuer oder geografisch begrenzt sein. Ob Sie Freelancer, ein Startup oder ein etabliertes Unternehmen irgendwo auf der Welt sind, Sie verdienen Zugang zum gleichen Niveau finanzieller Intelligenz.',
    ...
    storyPara3: 'Heute dient Legio Benutzern weltweit und hilft ihnen, Zeit zu sparen, Kosten zu senken und bessere finanzielle Entscheidungen durch intelligente Automatisierung und Expertenerkenntnisse zu treffen.',
    globalReach: 'Globale Reichweite',
    globalReachDesc: 'Legio Finance bedient Benutzer weltweit. Unsere Plattform ist so konzipiert, dass sie nahtlos über Grenzen hinweg funktioniert und mehrere Währungen und Sprachen unterstützt.',
    comingSoon: 'Demnächst',
    taxOptimization: 'Steueroptimierung',
    taxOptimizationDesc: 'Wir arbeiten an fortschrittlichen Steueroptimierungsfunktionen, die Ihnen helfen, Ihre Steuerlast legal und effizient zu minimieren. Bleiben Sie dran für intelligente Steuerstrategien.',
  ...
  fr: {
    ...
    storyPara1: "Legio Financial est né d'une simple observation : la gestion financière ne devrait pas être compliquée, coûteuse ou limitée par la géographie. Que vous soyez freelance, une startup ou une entreprise établie n'importe où dans le monde, vous méritez l'accès au même niveau d'intelligence financière.",
    ...
    storyPara3: "Aujourd'hui, Legio sert des utilisateurs dans le monde entier, les aidant à gagner du temps, réduire les coûts et prendre de meilleures décisions financières grâce à l'automatisation intelligente et aux insights d'experts.",
    globalReach: 'Portée mondiale',
    globalReachDesc: 'Legio Finance sert des utilisateurs dans le monde entier. Notre plateforme est conçue pour fonctionner de manière transparente au-delà des frontières, supportant plusieurs devises et langues.',
    comingSoon: 'Bientôt disponible',
    taxOptimization: 'Optimisation fiscale',
    taxOptimizationDesc: "Nous travaillons sur des fonctionnalités avancées d'optimisation fiscale pour vous aider à minimiser votre charge fiscale légalement et efficacement. Restez à l'écoute pour des stratégies fiscales intelligentes.",
