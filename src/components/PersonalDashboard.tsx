...
const PersonalDashboard = () => {
  ...
  const uploadReceipt = async (expenseId: string) => {
    ...
    try {
      ...
      return fileName;
    } catch (error) { console.error('Error uploading receipt:', error); return null; }
  };
  ...
  const basicCategories = [
    { id: 'expenses' as CategoryView, icon: Wallet, title: 'Expense Tracking', description: 'Track and categorize your daily spending', badge: 'Basic', locked: false },
    { id: 'credit-cards' as CategoryView, icon: CreditCard, title: 'Credit Cards', description: 'Manage your credit cards and transactions', badge: 'Basic', locked: false },
    { id: 'income-budget' as CategoryView, icon: TrendingUp, title: 'Income & Budget', description: 'Track your income sources and manage budgets', badge: 'Basic', locked: false },
  ];

  const proCategories = [
    { id: 'recurring-payments' as CategoryView, icon: RefreshCcw, title: 'Recurring Payments', description: 'Track subscriptions and recurring expenses', badge: 'Pro', locked: !hasProFeatures },
    { id: 'investments' as CategoryView, icon: LineChart, title: 'Investment Portfolio', description: 'Track and manage your investments', badge: 'Pro', locked: !hasProFeatures },
    { id: 'goals' as CategoryView, icon: Target, title: 'Financial Goals', description: 'Set and track your savings goals', badge: 'Pro', locked: !hasProFeatures },
    { id: 'calendar' as CategoryView, icon: Calendar, title: 'Financial Calendar', description: 'View bills, paydays, and financial dates', badge: 'Pro', locked: !hasProFeatures },
    { id: 'planner' as CategoryView, icon: Calculator, title: 'Financial Planner', description: 'Advanced projections and planning', badge: 'Pro', locked: !hasProFeatures },
  ];

  const handleCategoryClick = (category: typeof basicCategories[0]) => {
    if (category.locked) {
      toast({ title: "Pro Feature", description: "Upgrade to Personal Pro to access this feature.", variant: "default" });
      return;
    }
      ...
      {!hasProFeatures && (
        <Card className="border-2 border-primary/20">
          <CardHeader>
            ...
            <CardDescription>Upgrade to Personal Pro to access advanced features</CardDescription>
          </CardHeader>
          <CardContent className="space-y-3">
            <div className="space-y-2 text-sm">
              <div className="flex items-center gap-2"><div className="w-1.5 h-1.5 rounded-full bg-primary" /><span>Recurring payment tracking with due-date reminders</span></div>
              <div className="flex items-center gap-2"><div className="w-1.5 h-1.5 rounded-full bg-primary" /><span>Investment portfolio tracking with live prices</span></div>
              <div className="flex items-center gap-2"><div className="w-1.5 h-1.5 rounded-full bg-primary" /><span>Financial goals with progress tracking</span></div>
              <div className="flex items-center gap-2"><div className="w-1.5 h-1.5 rounded-full bg-primary" /><span>Financial calendar with bills, paydays & events</span></div>
              <div className="flex items-center gap-2"><div className="w-1.5 h-1.5 rounded-full bg-primary" /><span>AI financial advisor & advanced planning tools</span></div>
            </div>
            <Button className="w-full bg-gradient-primary hover:opacity-90 mt-4">Upgrade to Personal Pro - €10/month</Button>
          </CardContent>
        </Card>
      )}
    </div>
