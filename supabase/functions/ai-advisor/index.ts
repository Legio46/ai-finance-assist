...
serve(async (req) => {
  ...
  try {
    ...
    console.log("AI Advisor request received:", { message, context });

    const systemPrompt = `You are a professional financial and tax advisor AI assistant for Legio Financial. 
